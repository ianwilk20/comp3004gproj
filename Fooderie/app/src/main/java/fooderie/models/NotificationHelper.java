...
import fooderie.mealPlannerScheduler.views.WeeklyScheduleFragment_Proxy;
        ...
        Observer<List<PlanWeek>> o = new Observer<List<PlanWeek>>() {
            ...
            public void onChanged(@Nullable List<PlanWeek> plans) {
                if (plans == null || plans.size() == 0) {
                    Intent intent = new Intent(m_activity.getApplicationContext(), PlanRecipeRecyclerView.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);;
        ...
        Observer<List<ScheduleAndPlanWeek>> o = new Observer<List<ScheduleAndPlanWeek>>() {
            ...
            public void onChanged(@Nullable List<ScheduleAndPlanWeek> schedules) {
                ...
                if (s == null || s.pw == null || s.s.getPlanWeekId() != null) {
                    ...
                    Intent intent = new Intent(m_activity, WeeklyScheduleFragment_Proxy.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);;
                    PendingIntent pendingIntent = PendingIntent.getActivity(m_activity, 0, intent, 0);
